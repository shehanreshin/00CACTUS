...
export default function Hero() {
    return (
        <section className={`flex flex-col ${fonts.vanchrome.className} 2xl:text-[15vw] xl:text-[17vw] lg:text-[17.2vw] md:text-[17.2vw] leading-[0.79] tracking-npx2 justify-center gap-5`}>
